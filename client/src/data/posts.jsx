const posts = [
  {
      ...
      <p>
        ...
        <ul>
          <li>
            ...
            attended the GiveBackLabs climate tech event here in Columbus. I had
            a chance to learn from local climate leaders and work alongside
            other tech-driven members of our community to brainstorm solutions
            to climate issues.
          </li>
          <li>
            ...
            meetups, Code and Coffee, on May 13th.
          </li>
          <li>
            ...
            better comments. I also created a simple app I named <a href="https://github.com/amberhunt955/vite-recipe-app" target="blank">Menu Magic</a>,
          ...
          <li>
            ...
            is humane tech, so I've been working through the Foundations of
          ...
          <li>
            ...
            least: I designed this blog and wrote my first post!
          </li>
        </ul>
        <br />
    ...
    date: <p>Posted May 16, 2023 by <a href="/about">Amber Hunt</a></p>,
  },
];
